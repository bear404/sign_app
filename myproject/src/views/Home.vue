...
<section class="content-container">
    <div class="grid-content bg-purple-light">
        <!--<el-breadcrumb separator-class="el-icon-arrow-right">-->
            ...
            <!--<el-breadcrumb-item :to="{path:'/Table'}">学生列表</el-breadcrumb-item>-->
            <!--<el-breadcrumb-item :to="{path:'/user'}">总表</el-breadcrumb-item>-->
            <!--<el-breadcrumb-item></el-breadcrumb-item>-->
            <!--<el-breadcrumb-item>活动详情</el-breadcrumb-item>-->
        <!--</el-breadcrumb>-->
        <el-breadcrumb separator-class="el-icon-arrow-right" class="breadcrumb-inner" >
            <el-breadcrumb-item :to="{ path: '/main' }">首页</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/Table' }">用户表</el-breadcrumb-item>
            <el-breadcrumb-item :to="{ path: '/user' }">列表</el-breadcrumb-item>
            <el-breadcrumb-item></el-breadcrumb-item>
        </el-breadcrumb>
